...
<body>
    ...
    <?php
    $current_blog = 'blog1'; // Set this variable based on the current blog
    ?>
                    ...
                    <div class="d-flex align-items-start mb-4">
                        ...
                        <div>
                            <p class="wow fadeInUp" data-wow-delay="0.5s"
                                ...
                                ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus, veniam? Velit, optio.
                                Quisquam, debitis.</p>
                            <p class="wow fadeInUp" data-wow-delay="0.6s"
                                style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">Lorem
                                ipsum dolor sit amet, consectetur adipisicing elit. Nostrum, libero! Alias ad eveniet
                                distinctio labore.</p>
                            <h3 class="wow fadeInUp" data-wow-delay="0.7s"
                                style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInUp;">How to Pay
                                Down Insurance Bills</h3>
                            <p class="wow fadeInUp" data-wow-delay="0.8s"
                                style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">Lorem
                                ipsum dolor sit amet consectetur adipisicing elit. Ratione, officiis! Similique, nihil
                            ...
                            <h4 class="wow fadeInUp" data-wow-delay="1.0s"
                                style="visibility: visible; animation-delay: 1.0s; animation-name: fadeInUp;">Conclusion
                            </h4>
